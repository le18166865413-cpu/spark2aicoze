...
const DEFAULTS: Record<string, string> = {
  ...
  prompt_templates: JSON.stringify([
    { label: "图书主编招募", scenes: ["行政办公/教育"], usages: ["招聘招募"], styles: ["文艺"], colors: ["棕"], ratio: "3:4" },
    { label: "教培代理招募", scenes: ["行政办公/教育"], usages: ["招聘招募"], styles: ["商务"], colors: ["蓝", "绿"], ratio: "3:4" },
    { label: "餐饮节日宣传", scenes: ["生活娱乐"], usages: ["宣传推广"], styles: ["实景"], colors: ["橙", "红"], ratio: "1:1" },
    { label: "电商促销", scenes: ["电商"], usages: ["营销带货"], styles: ["时尚"], colors: ["红"], ratio: "1:1" },
    { label: "课程成果展示", scenes: ["行政办公/教育"], usages: ["交流分享"], styles: ["简约"], colors: ["蓝"], ratio: "3:4" },
    { label: "小红书封面", scenes: ["社交媒体"], usages: ["晒照分享"], styles: ["清新"], colors: ["粉"], ratio: "3:4" },
    { label: "视频封面", scenes: ["社交媒体"], usages: ["宣传推广"], styles: ["潮酷"], colors: ["黑"], ratio: "16:9" },
    { label: "图片重构", scenes: [], usages: [], styles: ["实景"], colors: [], ratio: "1:1" },
    { label: "电商主图", scenes: ["电商"], usages: ["营销带货"], styles: ["简约"], colors: ["白"], ratio: "1:1" },
    { label: "公众号配图", scenes: ["公众号"], usages: ["干货科普"], styles: ["扁平"], colors: ["蓝"], ratio: "1:1" },
    { label: "高考倒计时", scenes: ["行政办公/教育"], usages: ["交流分享"], styles: ["简约"], colors: ["红"], ratio: "3:4" },
    { label: "图书封面设计", scenes: ["行政办公/教育"], usages: ["简介介绍"], styles: ["文艺"], colors: ["棕"], ratio: "3:4" },
  ]),
