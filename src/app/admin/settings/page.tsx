...
export default function AdminSettingsPage() {
  ...
  if (!loading && !initialized) {
    setSiteName(get('general', 'site_name', 'SparkAI'));
    setSiteDescription(get('general', 'site_description', 'AI 驱动的海报生成与展示平台'));
    setSiteEnabled(get('general', 'site_enabled', 'true') === 'true');
    setRegisterEnabled(get('general', 'register_enabled', 'true') === 'true');
    setInitialized(true);
  }
