  ...
  return (
    <Dialog>
      ...
      <DialogContent className={cn(
        ...
        <div className="flex md:hidden items-center justify-center gap-2 py-3 px-4 border-b flex-shrink-0">
        ...
        <div className="w-full md:w-[400px] flex-shrink-0 px-1 pt-0 pb-4 md:p-8 flex flex-col gap-4 md:gap-6 bg-background md:h-full md:overflow-y-auto flex-1 md:flex-none">
          ...
          <div className="hidden md:flex items-center justify-between sticky top-0 bg-background z-10 pb-4 border-b">
            ...
            <Button
              onClick={handleLike}
              disabled={likeLoading}
              className={cn("rounded-full font-bold px-4 transition-all", liked ? "bg-red-500/15 text-red-400 hover:bg-red-500/25 border border-red-500/30 shadow-none" : "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_15px_rgba(34,197,94,0.15)]")}
            >
